...
export default function ScheduleModal({
  ...
  const isBulk = selectedConversations.length > 1;
      ...
      if (selectedConversations.length > 1) {
        const payload = {
          ...
          messages: selectedConversations.map((conv) => ({
            ...
            toEmail: conv.clientEmail,
            subject: form.subject || conv.subject || "Follow up",
        ...
        alert(res.data?.message || "Emails scheduled successfully");
        onClose();
        return;
      }

      // 🔹 SINGLE SCHEDULING (UNCHANGED)
      const payload = {
        accountId: account.id,
      ...
      <div className="bg-white w-full max-w-2xl rounded-xl shadow-xl">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h2 className="text-lg font-semibold text-gray-800">
            {isBulk ? "Schedule Follow-ups" : "Schedule Email"}
          </h2>
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder={
                isBulk
                  ? "Optional (applies to all selected conversations)"
                  : "Email subject"
              }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={
                isBulk
                  ? "Optional message (same content for all)"
                  : "Email message"
              }
          ...
          {isBulk && (
            <div className="text-xs text-gray-500 bg-blue-50 p-3 rounded-md">
              {selectedConversations.length} conversations selected. The same
        ...
        <div className="px-6 py-4 border-t flex items-center justify-end gap-2">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white rounded-md text-sm flex items-center gap-2 disabled:opacity-60"
          >
            {loading ? (
...
//         messages: selectedConversations.map((conv) => ({
//           conversationId: conv.conversationId,
//           toEmail: conv.clientEmail, // 🔥 AUTO
//           subject: form.subject || conv.subject || "Follow up",
//           bodyHtml: form.bodyHtml || "", // 🔥 SAME BODY FOR ALL
//         })),
//       };
